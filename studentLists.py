...
class ClassList:
    ...
    def is_class_full(self):
        '''Returns True if class is full, False if class is not full'''
        if len(self.class_list) >= (self.max_students):
            return True
...
def main():
    ...
    print(capstone.class_list)
    print(capstone.max_students)
    print("Is class full? ", capstone.is_class_full()) # True
